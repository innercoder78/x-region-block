(function () {
  ...
  const PRODUCT_NAME = 'X Region Reveal & Block';
  ...
  function settingsToFormModel(settings) {
    return {
  ...
  function formModelToSettingsInput(model) {
    return {
  ...
  function createOptionsController({ repository, view, confirmReset }) {
    let busy = false;
  ...
  function createOptionsView(document) {
